...
public abstract class Dialogue : ScriptableObject
{
    ...
    public List<SoundEffectSO> defTextAudios;
...
public abstract class RealDialogue
{
    ...
    public SoundEffectSO[] textAudios;
    ...
    { 
        ...
        textAudios = new SoundEffectSO[arraysLength];
    ...
    public void SetCustomTextAudio(int index, SoundEffectSO customTextAudio)
    {
