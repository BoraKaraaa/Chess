...
namespace Munkur
{
    public class DialogueManager : Singleton<DialogueManager>
    {
        ...
        public void DisplayNextSentence()
        {
            ...
            {
                activeDialogueHolder.soundEffect = realDialogue.textAudios[dialogueIndex];
            }
        ...
        IEnumerator TypeSentence(RealDialogue realDialogue)
        {
            ...
            if (activeDialogueHolder.soundEffect.isLooping == true)
            {
                AudioManager.Instance.PlaySoundEffect(activeDialogueHolder.soundEffect);
            }
            ...
            foreach (char letter in realDialogue.sentences[dialogueIndex])
            {
                ...
                if (letter != ' ')
                {
                    ...
                    if (activeDialogueHolder.soundEffect.isLooping == false)
                    {
                        AudioManager.Instance.PlaySoundEffect(activeDialogueHolder.soundEffect);
                    }
